...
public class MediaClientTest {
	...
	public void testCreateMedia() throws JWPlatformException {
		mockStatic(HttpCalls.class);
		JSONObject expected = new JSONObject("{" + "    \"id\": MEDIA_ID," + "    \"status\": \"ready\","
				+ "    \"media_type\": \"video\"," + "    \"hosting_type\": \"hosted\","
				+ "    \"error_message\": \"test message\"," + "    \"duration\": 100.0,"
				+ "    \"created\": \"2018-10-02T13:58:15.001887+00:00\","
				+ "    \"last_modified\": \"2018-10-01T13:58:15.001795+00:00\"," + "    \"schema\": None,"
				+ "    \"type\": \"media\"," + "    \"external_id\": \"1\"," + "    \"mime_type\": \"video/mp4\","
				+ "    \"metadata\": {" + "        \"title\": \"test title1\","
				+ "        \"description\": \"test description\"," + "        \"author\": \"me\","
				+ "        \"permalink\": \"site1.com\"," + "        \"category\": \"Automotive\","
				+ "        \"publish_start_date\": \"2018-10-01T13:58:15.001795+00:00\","
				+ "        \"publish_end_date\": \"2018-10-01T13:58:15.001795+00:00\","
				+ "        \"custom_params\": MEDIA_CUSTOM_PARAMS," + "        \"tags\": MEDIA_TAGS," + "    },"
				+ "    \"relationships\": {" + "        \"protection_rule\": {" + "            \"id\": \"protect2\","

...
public class EventsClientTest {
	...
	public void testAllMethods() throws JWPlatformException {
		...
		when(HttpCalls.request(anyString(), anyMap(), anyBoolean(), eq("PUT"), anyMap())).thenReturn(new JSONObject("{\"code\":\"Object creation successful\"}"));
		...
		Map<String,String> params = new HashMap<>();
		params.put("title", "test");
		JSONObject updateAdResp = eventsClient.requestMasterDownloadAvailability("siteId", "channelId", "eventId", params);
